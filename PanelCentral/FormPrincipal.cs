...
namespace PanelCentral
{
    public partial class FormPrincipal : Form
    {
        ...
        {
            //localizacion el eje x e y del formulario
            lx = this.Location.X;
            ly = this.Location.Y;
            // ancho y alto actual del formulario
            sw = this.Size.Width;
            sh = this.Size.Height;
            btnMaximizar.Visible = false;
            btnRestaurar.Visible = true;
            this.Size = Screen.PrimaryScreen.WorkingArea.Size; // El tamaño sera igual a la pantalla principal
            this.Location = Screen.PrimaryScreen.WorkingArea.Location; // locacion por defecto de la pantalla principal
        }
        ...
        // Crear Función de Arrastrar el formulario (Drag Form)
        /*
